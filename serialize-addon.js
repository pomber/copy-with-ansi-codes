// from https://github.com/xtermjs/xterm.js/blob/master/addons/xterm-addon-serialize/src/SerializeAddon.ts
...
export class SerializeAddon {
  ...
  _serializeBuffer(terminal, buffer, scrollback) {
    ...
    const selection =
      (_a = this._terminal) === null || _a === void 0
        ? void 0
        : _a.getSelectionPosition();
...
export class HTMLSerializeHandler extends BaseSerializeHandler {
  constructor(buffer, _terminal, _options) {
    ...
    this._colors = _terminal._core._themeService.colors;
  }
  ...
  _beforeSerialize(rows, start, end) {
    ...
    if (
      (_a = this._options.includeGlobalBackground) !== null && _a !== void 0
        ? _a
        : false
    ) {
      foreground =
        (_c =
          (_b = this._terminal.options.theme) === null || _b === void 0
            ? void 0
            : _b.foreground) !== null && _c !== void 0
          ? _c
          : "#ffffff";
      background =
        (_e =
          (_d = this._terminal.options.theme) === null || _d === void 0
            ? void 0
            : _d.background) !== null && _e !== void 0
          ? _e
          : "#000000";
    }
    ...
    this._htmlContent +=
      "<div style='" + globalStyleDefinitions.join(" ") + "'>";
  }
  _afterSerialize() {
